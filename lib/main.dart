                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //Primary nav items
                      ...List.generate(DashboardPage._mainDestinations.length, (
                        index,
                      ) {
                        final item = DashboardPage._mainDestinations[index];
                      ...
                      // Secondary nav items
                      ...List.generate(
                        DashboardPage._secondaryDestinations.length,
                        (i) {
                          final index =
                              i + DashboardPage._mainDestinations.length;
                          final item = DashboardPage._secondaryDestinations[i];
                          final isActive = selectedIndex == index;
                          return GestureDetector(
                            onTap: () {
                              setState(() => selectedIndex = index);
...
class OutlookScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Scaffold(body: Center(child: Text('Outlook')));
  }
}
...
class PopOutScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Scaffold(body: Center(child: Text('Pop out')));
  }
}
...
class SignOutScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Scaffold(body: Center(child: Text('Sign Out')));
  }
}
